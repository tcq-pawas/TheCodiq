...
const LAYOUTS: Record<GraphVariant, { nodes: NodeDef[]; edges: EdgeDef[] }> = {
  a: {
    ...
    edges: [
      { x1: "14%", y1: "28%", x2: "28%", y2: "42%", color: "rgba(45,156,255,0.12)" },
      { x1: "28%", y1: "42%", x2: "18%", y2: "58%", color: "rgba(45,156,255,0.10)" },
      { x1: "82%", y1: "30%", x2: "90%", y2: "48%", color: "rgba(242,201,76,0.11)" },
      { x1: "90%", y1: "48%", x2: "76%", y2: "62%", color: "rgba(111,207,74,0.10)" },
      { x1: "28%", y1: "42%", x2: "82%", y2: "30%", color: "rgba(45,156,255,0.08)" },
    ],
  },
  b: {
    nodes: [
    ...
    edges: [
      { x1: "10%", y1: "35%", x2: "22%", y2: "50%", color: "rgba(45,156,255,0.11)" },
      { x1: "22%", y1: "50%", x2: "12%", y2: "65%", color: "rgba(45,156,255,0.10)" },
      { x1: "86%", y1: "22%", x2: "92%", y2: "40%", color: "rgba(45,156,255,0.10)" },
      { x1: "92%", y1: "40%", x2: "80%", y2: "72%", color: "rgba(111,207,74,0.09)" },
    ],
  },
  c: {
    nodes: [
    ...
    edges: [
      { x1: "12%", y1: "24%", x2: "24%", y2: "38%", color: "rgba(45,156,255,0.11)" },
      { x1: "24%", y1: "38%", x2: "16%", y2: "72%", color: "rgba(111,207,74,0.09)" },
      { x1: "84%", y1: "26%", x2: "88%", y2: "55%", color: "rgba(242,201,76,0.11)" },
      { x1: "88%", y1: "55%", x2: "72%", y2: "78%", color: "rgba(45,156,255,0.09)" },
      { x1: "24%", y1: "38%", x2: "84%", y2: "26%", color: "rgba(45,156,255,0.07)" },
    ],
  },
  d: {
    nodes: [
    ...
    edges: [
      { x1: "8%", y1: "40%", x2: "20%", y2: "28%", color: "rgba(45,156,255,0.11)" },
      { x1: "20%", y1: "28%", x2: "18%", y2: "58%", color: "rgba(45,156,255,0.10)" },
      { x1: "88%", y1: "24%", x2: "92%", y2: "48%", color: "rgba(111,207,74,0.10)" },
      { x1: "92%", y1: "48%", x2: "78%", y2: "70%", color: "rgba(242,201,76,0.09)" },
    ],
  },
};
