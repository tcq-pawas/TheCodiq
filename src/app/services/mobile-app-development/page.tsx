        ...
        <div className="container max-w-7xl px-4 mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-8">
              <h2 className="text-[20px] font-bold text-white mb-6">Our Mobile App Services</h2>
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-gray-300">
                  <span className=" flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span className="text-[12px]">React Native Development - Build once, deploy on iOS and Android</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <span className=" flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span className="text-[12px]">Flutter Applications - Beautiful, fast, and expressive mobile apps</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <span className=" flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span className="text-[12px]">iOS & Android Native - Platform-specific optimized applications</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <span className=" flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span className="text-[12px]">App Store Optimization - Maximize visibility and downloads</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-gray-300">
                  ...
                  <span className="text-[12px]">Rapid development with cross-platform frameworks</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <span className=" flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span className="text-[12px]">Experienced team with 50+ successful app launches</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <span className=" flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span className="text-[12px]">Full-cycle development from design to deployment</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <span className=" flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span className="text-[12px]">Ongoing support and updates post-launch</span>
                </li>
              </ul>
            </div>
          </div>
