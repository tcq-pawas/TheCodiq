...
import { CloudCog, Check, ArrowRight } from "lucide-react";
        ...
        <div className="container max-w-7xl px-4 mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-8">
              <h2 className="text-2xl font-bold text-white mb-6">Our Cloud & DevOps Services</h2>
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-gray-300">
                  ...
                  <span>AWS & Azure - Cloud architecture design, migration, and management</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <span className="mt-1 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span>DevOps & CI/CD - Automated pipelines for continuous integration and deployment</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <span className="mt-1 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span>Microservices Architecture - Scalable, resilient application design patterns</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <span className="mt-1 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span>Serverless Computing - Event-driven architectures for optimal cost efficiency</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-gray-300">
                  ...
                  <span>Certified cloud engineers with AWS and Azure expertise</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <span className="mt-1 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span>Infrastructure as code for consistency and reproducibility</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <span className="mt-1 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                ...
                <li className="flex items-start gap-3 text-gray-300">
                  ...
                  <span>24/7 monitoring and support for production environments</span>
                </li>
              </ul>
            </div>
          </div>
