        ...
        <div className="container max-w-7xl px-4 mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-8">
              <h2 className="text-[20px] font-bold text-white mb-6">Our Marketing Services</h2>
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-gray-300">
                  <span className=" flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span className="text-[12px]">SEO Optimization - Technical SEO, on-page optimization, and link building</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <span className=" flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span className="text-[12px]">Content Marketing - Strategic content that attracts and engages your audience</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span className="text-[12px]">Social Media Marketing - Build brand presence and engage followers</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span className="text-[12px]">PPC Advertising - Targeted paid campaigns for immediate results</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-gray-300">
                  ...
                  <span className="text-[12px]">Specialized expertise in tech and e-commerce marketing</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span className="text-[12px]">Data-driven strategies with clear ROI measurement</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span className="text-[12px]">Integrated approach combining organic and paid channels</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <Check className="h-3 w-3" strokeWidth={2.4} />
                  </span>
                  <span className="text-[12px]">Transparent reporting and regular strategy reviews</span>
                </li>
              </ul>
            </div>
          </div>
