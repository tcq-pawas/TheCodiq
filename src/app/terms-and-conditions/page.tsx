        ...
        <div className="relative z-10 container max-w-4xl px-4 mx-auto">
          <div className="prose prose-invert max-w-none">
            <div className="bg-white border border-[#C5D5EB] rounded-2xl p-8 shadow-[0_18px_60px_rgba(37,99,235,.08)]">
              ...
              <h1 className="text-3xl font-bold text-[#111827] mb-6">Terms & Conditions</h1>
              <p className="text-[#475569] mb-4">Last updated: {new Date().toLocaleDateString()}</p>

              <h2 className="text-xl font-bold text-[#111827] mt-8 mb-4">1. Acceptance of Terms</h2>
              ...
              <h2 className="text-xl font-bold text-[#111827] mt-8 mb-4">2. Services</h2>
              <p className="text-[#475569] mb-4">
              ...
              <h2 className="text-xl font-bold text-[#111827] mt-8 mb-4">3. User Responsibilities</h2>
              <p className="text-[#475569] mb-4">Users agree to:</p>
              ...
              <h2 className="text-xl font-bold text-[#111827] mt-8 mb-4">4. Intellectual Property</h2>
              <p className="text-[#475569] mb-4">
              ...
              <h2 className="text-xl font-bold text-[#111827] mt-8 mb-4">5. Payment Terms</h2>
              <p className="text-[#475569] mb-4">
              ...
              <h2 className="text-xl font-bold text-[#111827] mt-8 mb-4">6. Limitation of Liability</h2>
              <p className="text-[#475569] mb-4">
              ...
              <h2 className="text-xl font-bold text-[#111827] mt-8 mb-4">7. Termination</h2>
              <p className="text-[#475569] mb-4">
              ...
              <h2 className="text-xl font-bold text-[#111827] mt-8 mb-4">8. Governing Law</h2>
              <p className="text-[#475569] mb-4">
                These terms shall be governed by and construed in accordance with the laws of India, without regard to its conflict of law provisions.
              </p>

              <h2 className="text-xl font-bold text-[#111827] mt-8 mb-4">9. Changes to Terms</h2>
              <p className="text-[#475569] mb-4">
                We reserve the right to modify these terms at any time. Continued use of our services after changes constitutes acceptance of the new terms.
              </p>

              <h2 className="text-xl font-bold text-[#111827] mt-8 mb-4">10. Contact Us</h2>
              <p className="text-[#475569] mb-4">
                For questions about these Terms & Conditions, please contact us at:
              </p>
              <p className="text-[#475569] mb-4">
                Email: <a href="mailto:legal@thecodiq.com" className="text-[#2563EB] hover:underline">legal@thecodiq.com</a>
              </p>
            </div>
          </div>
        </div>
